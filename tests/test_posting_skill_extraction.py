...
class TestExtractPostingSkills:
    def test_only_new_postings_call_the_llm(
        ...
        out = sg_nodes.extract_posting_skills(
            postings_df, cached_skills, cv_params, skill_graph_params, stub
        )
    ...
    def test_columns_match_schema(
        self, postings_df, cached_skills, cv_params, skill_graph_params, posting_response
    ):
        stub = StubOllama([posting_response])
        out = sg_nodes.extract_posting_skills(
            postings_df, cached_skills, cv_params, skill_graph_params, stub
    ...
    def test_forwards_generation_options(
        ...
        assert (
            ...
            == skill_graph_params["extraction"]["generation"]
        )
    ...
    def test_per_posting_failure_is_isolated(
        self, postings_df, cached_skills, cv_params, skill_graph_params
    ):
    ...
    def test_no_postings_returns_cache_unchanged(
        self, cached_skills, cv_params, skill_graph_params
    ):
        stub = StubOllama()
        out = sg_nodes.extract_posting_skills(
    ...
    def test_bare_list_response_is_coerced(
        self, cv_params, skill_graph_params
    ):
